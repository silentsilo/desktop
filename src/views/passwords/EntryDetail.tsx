 ...
 *
 * Reveal state lives here so it dies with the selection: moving to another
 * entry or another view never leaves a previously revealed password mounted
      ...
      <div className="pw-card-fields">
        ...
        {entry.notes && (
          <div className="pw-field-row pw-field-notes">
            ...
            <span className="pw-field-value pw-notes-value">{entry.notes}</span>
          </div>
        )}
      </div>
    </div>
