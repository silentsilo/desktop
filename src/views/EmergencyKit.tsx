    ...
    <div className={`kit-sheet${variant ? ` ${variant}` : ""}`} aria-hidden>
      ...
      <section className="kit-section">
        ...
        <ol className="kit-steps">
          <li>
            Go to <strong>silentsilo.com</strong> and download SilentSilo for that computer.
          </li>
          <li>Install it and open it.</li>
          <li>
            On the first screen choose <strong>I already have a silo</strong>.
          </li>
          <li>
            Say where the silo is. Either of these works, whichever you have:
            <ul className="kit-substeps">
              <li>
                <strong>Set up from backup storage</strong>, then sign in to wherever this silo
                backs up: SilentSilo storage, an S3-compatible bucket, a folder or network
                share, WebDAV, or SFTP. Not written on this sheet, because you know it and a
                stranger holding this should not.
              </li>
              <li>
                <strong>Open an existing silo folder</strong>, if you still have the folder
                itself on an external drive or another computer.
              </li>
            </ul>
          </li>
          <li>
