...
export function UnlockView({
  ...
  if (usingCode) {
    return (
      <AuthShell title="SilentSilo" subtitle="Unlock with the code you wrote down.">
        ...
        <form
          ...
          onSubmit={(e) => {
            e.preventDefault();
            if (!busy && code.trim()) onUnlockWithRecovery(code);
          }}
        >
          <h2>Recovery code</h2>
          <p className="hint">
            The long code you saved when you set this up. Dashes, spaces and capitals do not
            matter.
          </p>
  ...
  return (
    <AuthShell title="SilentSilo" subtitle={subtitle}>
